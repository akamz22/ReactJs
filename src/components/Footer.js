    ...
    <div class="flex items-end w-full min-h-screen bg-white">
      ...
      <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div
          ...
          <img alt='logo' src={foodvilla}/>
            <p class="mt-2 text-sm text-gray-500">Good Food , Good Life</p>
            <div class="mt-4">
          ...
          <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            ...
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
              ...
              <nav class="mb-10 list-none">
                ...
                <li class="mt-3">
                  <a class="text-gray-500 cursor-pointer hover:text-gray-900">{user.email}</a>
                </li>
              </nav>
            </div>
          </div>
